...
<div class="wpneo-campaign-creator-info-wrapper">
    ...
    <div class="wpneo-campaign-creator-details">
        ...
        <p><?php echo wpneo_crowdfunding_author_all_campaigns()->post_count; ?> <?php _e("Companies","wp-crowdfunding"); ?> | <?php echo wpneo_loved_campaign_count(); ?> <?php _e("Watch List","wp-crowdfunding"); ?> </p>
