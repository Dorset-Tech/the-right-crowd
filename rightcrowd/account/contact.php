...
<div class="form-group">
    <label for="address1"><?php _e('Address Line 1','themeum'); ?></label>
    <input class="form-control" id="address1" name="address1" type="text" value="<?php echo $address1; ?>" disabled />
</div>

<div class="form-group">
    <label for="address2"><?php _e('Address Line 2','themeum'); ?></label>
...
<div class="form-group">
    <label for="zip"><?php _e('Zip Code','themeum'); ?></label>
...
<div class="form-group">
    ...
    <input class="form-control" id="country" name="country" type="text" value="<?php echo $country; ?>" disabled />
            ...
            <div class="form-group pull-right">
                <button class="btn btn-default edit-form"><i class="fa fa-pencil-square-o"></i> <?php _e('Edit','themeum'); ?></button>
                <button type="submit" class="btn btn-default" disabled><i class="fa fa-floppy-o"></i> <?php _e('Save','themeum'); ?></button>
            </div>
        </form>
