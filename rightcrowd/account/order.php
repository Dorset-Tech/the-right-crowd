<div class="col-md-12">
    <ul class="text-left submenu">
        <li class="active"><a href="?id=order"><?php _e("Pledges I've Received on My Projects","themeum"); ?></a></li>
    </ul>
    ...
    $the_query = new WP_Query( $args ); 
        ...
        echo '<table class="table table-hover">
                    <thead> 
                        <tr>
                            <th>#</th>
                            <th>'.__("Project Title","themeum").'</th>
                            <th>'.__("Backer","themeum").'</th>
                            <th>'.__("Date","themeum").'</th>
                            <th>'.__("Amount","themeum").'</th>
                        </tr>
                    </thead>
                    <tbody>';
            ...
            while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
                ...
                <tr>
                    ...
                    <td><?php echo $currencyCode; ?> <?php echo get_post_meta( get_the_ID(),'themeum_investment_amount', true ); ?></td>
                </tr>
