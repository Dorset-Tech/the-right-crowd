    ...
    <div class="dashboard-content">
            ...
            <section class="details-page">
                        ...
                        if(isset($_GET['project_id'])): 
                            ...
                            $type       = get_post_meta(get_the_ID(), "thm_type", true);
                            $location   = get_post_meta(get_the_ID(), "thm_location", true);
                            $start      = get_post_meta(get_the_ID(), "thm_start_date", true); 
                            $end        = get_post_meta(get_the_ID(), "thm_end_date", true); 
                            $goal       = get_post_meta(get_the_ID(), "thm_funding_goal", true); 
                        ?>
