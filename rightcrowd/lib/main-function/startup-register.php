...
if(!function_exists('themeum_style')):
    ...
    function themeum_style(){
        ...
        if(themeum_system_check()){
            ...
            wp_enqueue_script('jquery-validate','https://ajax.aspnetcdn.com/ajax/jquery.validate/1.14.0/jquery.validate.min.js',array(),false,true);
            wp_enqueue_script('main',THMJS.'startup-main.js',array(),false,true);
        }else{
            wp_enqueue_script('main',THMJS.'crowdfunding-main.js',array(),false,true);
        }
    ...
    function themeum_plugins_include()
    {
        $plugins = array(
                ...
                array(
                    ...
                    'source'                => 'https://downloads.wordpress.org/plugin/wp-crowdfunding.zip',
                    'required'              => false,
                    'version'               => '',
                    'force_activation'      => false,
                    'force_deactivation'    => false,
