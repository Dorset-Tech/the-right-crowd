    ...
    <div class="modal-dialog modal-md">
         <div class="modal-content">
             ...
             <div class="modal-body text-center">
                 ...
                 <p><?php _e('Please fill Project Title , Project Budget, Start Date and End Date.','themeum') ?></p>
             </div>
         </div>
    </div> 
</div>
                        ...
                        <!--div class="project-submit-form form-show wow fadeIn" data-wow-delay=".2s"-->
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <select name="project-category" id="project-category">
                                    <?php
                                    $argss = array('hide_empty'=>false);
                                    $all_cat = get_terms( 'project_category',$argss ); 
                            ...
                            <div class="form-group project-duration">
                                ...
                                <input type="text" id="start-date" name="start-date" class="form-control datepicker" value="03/04/2016"><i class="divider fa fa-minus"></i>
                                <input type="text" id="end-date" name="end-date" class="form-control datepicker" value="05/14/2017"> 
                            </div>
