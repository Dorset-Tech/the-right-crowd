...
if (!class_exists('Redux_Framework_sample_config')) {
    ...
    class Redux_Framework_sample_config {
        ...
        public function setSections() {
            ...
            ***********************************/
            $this->sections[] = array(
                'title'     => __('Plugins System', 'Home Setting'),
                'icon'      => 'el-icon-cog',
                ...
                'fields'    => array(
                    ...
                    array(
                        'id'       => 'system-plugins',
                        'type'     => 'select',
                        'title'    => __('Select System', 'themeum'),
                        'subtitle' => __('Select Startup Idea default system or WP Crowdfunding plugins system.', 'themeum'),
                        'options'  => array(
                            'startupidea'       => 'Startupidea Default',
                            'crowdfunding'      => 'WP Crowdfunding Plugins'
                        ),
                        'default'  => 'startupidea',
                    ),                             
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        'id'        => 'shop-slug',
                        'type'      => 'text',
                        'title'     => __('Slug of Shop Text', 'themeum'),
                        'subtitle' => __('Use your slug text for shop Ex. Startup Idea', 'themeum'),
                        'default'   => 'Shop',
                    ),
                    array( 
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        ...
                        'default'   => 'Thanks',   
                        'required'  => array('system-plugins', "=", "startupidea"),                                       
                    ),
                    array(
                        'id'        => 'ratting-msg-body',
                        'type'      => 'textarea',
