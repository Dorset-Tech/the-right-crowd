            ...
            <div class="dashboard-main col-md-12 nopadding">
                <div class="dashboard-sidebar col-md-3 nopadding">
                    <ul>
                        ...
                        <li <?php if( ($get_id=="project") || ($get_id=="update") ){ echo 'class="active"'; } ?>><a href="?id=project" ><i class="fa fa-archive"></i> <?php _e('My Projects','themeum'); ?></a></li>
                        <li <?php if( ($get_id=="invest") || ($get_id=="ratting") ){ echo 'class="active"'; } ?>><a href="?id=invest" ><i class="fa fa-university"></i> <?php _e('Backed Projects','themeum'); ?></a></li>
                        <li <?php if( $get_id=="order" ){ echo 'class="active"'; } ?>><a href="?id=order" ><i class="fa fa-rocket"></i> <?php _e('Pledges Received','themeum'); ?></a></li>
                        <li <?php if( $get_id=="search" ){ echo 'class="active"'; } ?>><a href="?id=search" ><i class="fa fa-search"></i> <?php _e('Search Pledges','themeum'); ?></a></li>
                        <li <?php if( $get_id=="password" ){ echo 'class="active"'; } ?>><a href="?id=password" ><i class="fa fa-crosshairs"></i> <?php _e('Change Password','themeum'); ?></a></li>
                    </ul>
                </div>
